# register user on  https://nice-dune-07e53ec0f.2.azurestaticapps.net/
# browse users ordered  https://ambitious-stone-0f6b9760f.2.azurestaticapps.net
# vs_WlkZVc11hBdT6A3zvuDwk5X5
#Created vector store, ID: vs_WlkZVc11hBdT6A3zvuDwk5X5
#Created vector store file batch, ID: vsfb_81af6a6c0c24479580e1e78c701a4879
import os
import time
...
vector_store_id = "vs_WlkZVc11hBdT6A3zvuDwk5X5"
